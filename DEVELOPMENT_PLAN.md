...
| **Y.3 Релиз в Яндекс.Игры** | 🔄 Y3.14/15 — фиксы аудита ECONOMY.md | P0 |
...
| **2b. Y.2 — Экономика V12** | **✅ 28.08.2026** — economy-store, quest-store, UI, бейджи, i18n |
| **2c. Y.3 — Релиз в Яндекс** | **🔄 Y3.14/15 — исправления аудита ECONOMY.md** |
