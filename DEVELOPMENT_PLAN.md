...
| Задача | Статус |
|--------|--------|
| Компонент IconButton (универсальный) | 🔲 Не начата |
| Замена текстовых кнопок в тулбаре на IconButton | 🔲 Не начата |
| Добавить тултипы для всех кнопок | 🔲 Не начата |
| Адаптация под тему (светлая/тёмная) | 🔲 Не начата |
