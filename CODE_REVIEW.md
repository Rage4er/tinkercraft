...
## 📋 Статус исправлений (Раунд 10 — UX история цвета — 2026-07-21)

| # | Проблема | Статус | Описание |
|---|---|---|---|
| UX-1 | История цвета: все микродвижения мыши по палитре | ✅ ИСПРАВЛЕНО | Draft color state + `skipHistory` в setColor — commit в историю только при onBlur или смене объекта |
