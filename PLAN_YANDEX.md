...
# 🗺️ ДОРОЖНАЯ КАРТА: ПРОДВИЖЕНИЕ И ПОДДЕРЖКА

> Это **стратегический план по продвижению и поддержке** в Яндекс.Играх. Отделяем **развитие CAD** (независимо) от **продвижения в Яндексе** (маркетинговые активности).

## Дорожная карта

```mermaid
flowchart LR
A[Релиз v1.0<br/>в Яндекс.Игры] --> B[Неделя в новинках]
B --> C[А/Б тест обложки<br/>2 недели]
C --> D[Промоакция #1<br/>День Premium бесплатно<br/>5 дней]
D --> E[А/Б тест обложки #2<br/>2 недели]
E --> F[Промоакция #2<br/>Все фигуры бесплатно<br/>5 дней]
F --> G[Обновление CAD<br/>+ новая фича]
G --> H[Промоакция #3<br/>Новая фича бесплатно<br/>5 дней]
H --> I[Цикл повторяется]
...
## 📋 ЧЕК-ЛИСТ: ПОДГОТОВКА К РЕЛИЗУ (ДО ЗАГРУЗКИ)

### 🔧 Техническая подготовка

- [ ] **Метрики подключены и настроены:**
  - [ ] Покупки подписок (конверсия)
  - [ ] Просмотры рекламы (количество, доход)
  - [ ] Экспорты STL (количество, сложность)
  - [ ] Импорты STL (количество)
  - [ ] Сохранения проектов
  - [ ] Доход/расход токенов (баланс)
  - [ ] Retention D1 / D7
  - [ ] Выполнение заданий
  - [ ] Конверсия в подписку (14 дней)
  - [ ] Медианный баланс токенов

- [ ] **Флаги для промоакций:**
  - [ ] `flag_promo_premium_free` — день Premium бесплатно
  - [ ] `flag_promo_all_shapes_free` — все фигуры бесплатно
  - [ ] `flag_promo_new_feature_free` — новая фича бесплатно
  - [ ] `flag_promo_active` — включить промо
  - [ ] `flag_promo_start_date` — дата начала
  - [ ] `flag_promo_end_date` — дата окончания
  - [ ] `flag_ab_test_cover_variant` — вариант обложки (A/B)

- [ ] **Система промоакций:**
  - [ ] Механика «День Premium бесплатно» (активируется флагом)
  - [ ] Механика «Все фигуры бесплатно» (активируется флагом)
  - [ ] Механика «Новая фича бесплатно» (активируется флагом)
  - [ ] UI-индикатор активной промоакции
  - [ ] Уведомление для игроков (баннер/попап)

- [ ] **А/Б тестирование обложек:**
  - [ ] 2 варианта обложки загружены в игру
  - [ ] Система ротации (50/50)
  - [ ] Сбор метрик по каждому варианту (CTR, конверсия)

---

## 🚀 ЧЕК-ЛИСТ: ПОСЛЕ РЕЛИЗА (НЕДЕЛЯ 1)
...
- [ ] **Проверить метрики:**
  ...
  - [ ] Баланс токенов (медианный)

- [ ] **Проверить стабильность:**
  - [ ] Нет падений/ошибок
  - [ ] Яндекс.SDK работает корректно
  - [ ] Сохранения в облаке работают

- [ ] **Ответить на отзывы:**
  - [ ] Положительные — поблагодарить
  - [ ] Отрицательные — предложить помощь

---

## 📊 ЧЕК-ЛИСТ: НЕДЕЛЯ 2–3 (А/Б ТЕСТ ОБЛОЖКИ)

### 🎨 А/Б тест

- [ ] **Запустить А/Б тест обложки:**
  - [ ] Вариант A (текущая)
  - [ ] Вариант B (новая)
  - [ ] Ротация 50/50

- [ ] **Сбор данных:**
  - [ ] CTR по каждому варианту
  - [ ] Конверсия в установку
  - [ ] Конверсия в запуск игры

- [ ] **Выбрать победителя:**
  - [ ] Проанализировать данные (2 недели)
  - [ ] Выбрать вариант с лучшим CTR
  - [ ] Обновить обложку в Яндекс.Играх

---

## 🎁 ЧЕК-ЛИСТ: НЕДЕЛЯ 4 (ПРОМОАКЦИЯ #1)

### 🎉 Промоакция: День Premium бесплатно

- [ ] **Включить флаг:**
  - [ ] `flag_promo_premium_free = true`
  - [ ] `flag_promo_start_date = <дата>`
  - [ ] `flag_promo_end_date = <дата + 5 дней>`

- [ ] **Мониторинг:**
  - [ ] Количество активаций Premium
  - [ ] Конверсия в покупку подписки после промо
  - [ ] Retention D7 / D14
...
## 🔁 ЧЕК-ЛИСТ: НЕДЕЛЯ 5–6 (А/Б ТЕСТ #2)

### 🎨 Повторный А/Б тест

- [ ] **Запустить А/Б тест новой обложки:**
  - [ ] Вариант A (текущая)
  - [ ] Вариант B (новая, после первых метрик)
...
## 🎁 ЧЕК-ЛИСТ: НЕДЕЛЯ 7 (ПРОМОАКЦИЯ #2)

### 🎉 Промоакция: Все фигуры бесплатно

- [ ] **Включить флаг:**
  - [ ] `flag_promo_all_shapes_free = true`
  - [ ] `flag_promo_start_date = <дата>`
  - [ ] `flag_promo_end_date = <дата + 5 дней>`

- [ ] **Мониторинг:**
  - [ ] Активность игроков (DAU)
  - [ ] Количество созданных моделей
  - [ ] Количество экспортов
  - [ ] Конверсия в подписку

---

## 🔄 ЧЕК-ЛИСТ: ПОСТОЯННЫЙ ЦИКЛ

### 🔄 Каждое обновление CAD

- [ ] **Новая фича:**
  - [ ] Добавить флаг `flag_promo_new_feature_free`
  - [ ] Включить промо на 5 дней
...
- [ ] **Корректировка стратегии:**
  - [ ] Если баланс > 2000 — добавить стоки
  - [ ] Если конверсия < 3% — пробный день Pro
  - [ ] Если D7 < 15% — стрики, достижения

---

## 📋 ИТОГОВЫЙ ЧЕК-ЛИСТ (СВОДНЫЙ)

| Этап | Задача | Статус |
|------|--------|--------|
| **До релиза** | Метрики настроены | 🔲 |
| **До релиза** | Флаги промоакций готовы | 🔲 |
| **До релиза** | А/Б тест обложек готов | 🔲 |
| **До релиза** | Механики промоакций реализованы | 🔲 |
| **Неделя 1** | Мониторинг стабильности | 🔲 |
| **Неделя 1** | Ответы на отзывы | 🔲 |
| **Неделя 1** | Сбор базовых метрик | 🔲 |
| **Неделя 2–3** | А/Б тест обложки #1 | 🔲 |
| **Неделя 2–3** | Выбор победителя | 🔲 |
| **Неделя 2–3** | Обновление обложки | 🔲 |
| **Неделя 4** | Промоакция #1: День Premium бесплатно | 🔲 |
| **Неделя 5–6** | А/Б тест обложки #2 | 🔲 |
| **Неделя 7** | Промоакция #2: Все фигуры бесплатно | 🔲 |
| **Постоянно** | Цикл обновлений CAD + промо | 🔲 |
| **Постоянно** | Анализ метрик | 🔲 |
| **Постоянно** | Корректировка стратегии | 🔲 |
...
|----------|-------|-------|
| **Ответы на отзывы** | Ежедневно | Повышает рейтинг и доверие |
| **Публикация обновлений** | С каждым релизом | Новые игроки приходят на обновления |
| **Промо в соцсетях** | Во время промоакций | Дополнительный трафик |
| **Анализ конкурентов** | Еженедельно | Понимать тренды |
| **Тестирование новых механик** | По данным | Улучшать удержание |

---

**Этот чек-лист готов к использованию.**
