// src/store/economy-config.ts — Константы экономики по ECONOMY.md v2.1
// Версия: 2.1 · Дата: 11.09.2026
// U1/U9: реклама per-reward — свой кулдаун 5 мин и свой лимит ≤3/день
// на каждый вид награды (токены / импорт / баннер)
...
export const LIMITS = {
  /** Макс доход в день (v2.1: реклама 3 вида × 3 × 50 = 450, итого 50+450+100+30+75 = 705) */
  maxPerDay: 705,
  /** Реалистичный доход в день (v2.1: ~2–3 вида рекламы × 2–3 показа, бонус, квесты, кэшбэк) */
  realisticPerDay: 350,

  /**
   * U1/U9: просмотры рекламы в день — НА КАЖДЫЙ ВИД награды
   * (tokens / import / banner), §2 ECONOMY.md v2.1
   */
  adsPerDay: 3,
