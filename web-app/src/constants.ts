...
export const TOOLTIP_DATA: Record<string, TooltipData> = {
  ...
  // Порядок действий:
  // 1. Выбери объект(ы), которые хочешь подвинуть
  // 2. Зажми Shift и выбери объект-якорь (он останется на месте)
  // 3. Нажми кнопку выравнивания
  // Все объекты (кроме якоря) выровняются по выбранной грани/центру якоря.
  align_x_min: {
    label: 'X min',
    description: '⬅ Выровнять по левой грани якоря (по оси X). Все выбранные объекты (кроме якоря) сдвинутся, чтобы их левая грань совпала с левой гранью якоря. Якорь остаётся на месте.',
  },
  align_x_center: {
    label: 'X center',
    description: '⟷ Выровнять по центру якоря (по оси X). Все выбранные объекты сдвинутся, чтобы их центр по X совпал с центром якоря по X. Якорь остаётся на месте.',
  },
  align_x_max: {
    label: 'X max',
    description: '➡ Выровнять по правой грани якоря (по оси X). Все выбранные объекты сдвинутся, чтобы их правая грань совпала с правой гранью якоря. Якорь остаётся на месте.',
  },
  align_y_min: {
    label: 'Y min',
    description: '⬇ Выровнять по нижней грани якоря (по оси Y). Все выбранные объекты сдвинутся, чтобы их нижняя грань совпала с нижней гранью якоря. Якорь остаётся на месте.',
  },
  align_y_center: {
    label: 'Y center',
    description: '↕ Выровнять по центру якоря (по оси Y). Все выбранные объекты сдвинутся, чтобы их центр по Y совпал с центром якоря по Y. Якорь остаётся на месте.',
  },
  align_y_max: {
    label: 'Y max',
    description: '⬆ Выровнять по верхней грани якоря (по оси Y). Все выбранные объекты сдвинутся, чтобы их верхняя грань совпала с верхней гранью якоря. Якорь остаётся на месте.',
  },
  align_z_min: {
    label: 'Z min',
    description: '◧ Выровнять по ближней грани якоря (по оси Z). Все выбранные объекты сдвинутся, чтобы их ближняя грань совпала с ближней гранью якоря. Якорь остаётся на месте.',
  },
  align_z_center: {
    label: 'Z center',
    description: '⦿ Выровнять по центру якоря (по оси Z). Все выбранные объекты сдвинутся, чтобы их центр по Z совпал с центром якоря по Z. Якорь остаётся на месте.',
  },
  align_z_max: {
    label: 'Z max',
    description: '◨ Выровнять по дальней грани якоря (по оси Z). Все выбранные объекты сдвинутся, чтобы их дальняя грань совпала с дальней гранью якоря. Якорь остаётся на месте.',
  },
